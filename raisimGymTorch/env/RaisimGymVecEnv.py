...
class RaisimGymVecEnv:
    ...
    def __init__(self, impl, normalize_ob=True, seed=0, clip_obs=10.):
        ...
        self._est_state = np.zeros([self.num_envs, self.num_est], dtype=np.float32)
    ...
    def get_state(self, update_statistics=True):
        self.wrapper.getState(self._est_state, update_statistics)
