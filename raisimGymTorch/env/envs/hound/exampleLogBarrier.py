...
x_values = np.linspace(-20, 20, 400)  # Avoiding x=alpha_lower directly as it goes to -inf in log
# y_values = [1e-1*relaxed_log_barrier(delta, alpha_lower, alpha_upper, x) for x in x_values]
