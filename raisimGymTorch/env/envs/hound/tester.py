...
# weight_path = "/home/gijeong/workspace/raisimLib/hound/raisimGymTorch/data/hound/2023-12-02-13-02-04/full_600.pt"
weight_path = "/home/gijeong/workspace/raisimLib/hound/raisimGymTorch/data/hound/2023-12-04-15-40-34/full_8000.pt"
# weight_path = "/home/gijeong/workspace/raisimLib/hound/raisimGymTorch/data/hound/2023-12-02-13-02-04/full_8000.pt"
...
if weight_path == "":
    ...
    for step in range(max_steps):
        if joystick == 1 :
            if (step % 10 == 0):
                command_x = -1.5 * pygame.joystick.Joystick(0).get_axis(1)
                if (command_x < -1):
                    command_x = -1.0
