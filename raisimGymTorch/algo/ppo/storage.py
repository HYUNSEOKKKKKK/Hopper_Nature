...
class RolloutStorage:
    ...
    def add_transitions(self, actor_obs, critic_obs, est_obs,true_state, actions, rewards, dones, actions_log_prob):
    ...
    def mini_batch_generator_shuffle(self, num_mini_batches):
        ...
        for indices in BatchSampler(SubsetRandomSampler(range(batch_size)), mini_batch_size, drop_last=True):
            ...
            yield actor_obs_batch, critic_obs_batch, est_obs_batch, true_state_batch, actions_batch, values_batch, advantages_batch, returns_batch, old_actions_log_prob_batch
